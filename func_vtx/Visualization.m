function Visualization(cell,edge,vtx,prm,init_window, INIT_VER, flag)

%plot(cell.pos(:,1),cell.pos(:,2),'ob');
if flag==1
    win=max(abs(reshape(vtx.pos,vtx.numb*2,1)));
    if win*1.1>init_window
        vis_window=win*1.1;
    else
...
elseif flag==2
    ...
    a1=axes;
    %patch(x,y,cell.curv,'FaceColor','none')
    patch(a1, x,y, cell.Factin,'FaceColor','flat');
